...
export const ButtonWrapper = styled.div<ButtonProps>`
    ...
    button{
        ...
        &:disabled{
            background-color:${({correct, userClicked})=>correct? 'lightgreen': !correct&&userClicked? '#ff5b4f': 'lightgray'};
            color: ${({correct, userClicked})=>correct? 'black': !correct&&userClicked? 'white': 'grey'};;
